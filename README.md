...
Reemplazar `usuariodemysql` y `passwordDeMysql` con tus propias credenciales para conectarte a postgres. Este archivo va ser ignorado en la subida a github, ya que contiene información sensible (las credenciales).

Adicionalmente será necesario que creen desde phpmyadmin una base de datos llamada `dogs`
