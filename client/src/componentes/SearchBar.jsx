...
const SearchBar = () => {
  ...
  console.log("🚀 ~ file: SearchBar.jsx:10 ~ SearchBar ~ selectedOptions", selectedOptions)
  ...
  const filterDogs = dogs.filter(dog => dog.name.toLowerCase().split(' ').some(name => name.startsWith(selectedOptions)))
  console.log("🚀 ~ file: SearchBar.jsx:20 ~ SearchBar ~ filterDogs", filterDogs)
